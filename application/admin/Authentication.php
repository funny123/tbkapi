...
class Authentication extends Base
{
    ...
    //身份认证
    public function check_user($bankcardno,$name,$idcardno,$phone)
    {
        $ch = curl_init();
        $url = 'http://apis.baidu.com/apix/bankcard_check/bankcard_four?bankcardno='.$bankcardno.'&name='.$name.'&idcardno='.$idcardno.'&phone='.$phone;
        $header = array(
            'apikey: 您自己的apikey',
        );
        // 添加apikey到header
