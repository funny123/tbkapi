<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"F:\myphp_www\PHPTutorial\WWW\eintcoin\public/../application/admin\view\coupon\index.html";i:1527510489;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\header.html";i:1527512283;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\footer.html";i:1521703318;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >
                        <a href="<?php echo url('dumpxls'); ?>"><button class="btn btn-outline btn-primary" type="button">导入优惠券</button></a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Coupon/index"); ?>', {page: curr || 1,key:key}, function(data){
...
function del_coupon(id){
    lunhui.confirm(id,'<?php echo url("del_coupon"); ?>');
}

//用户会员
function coupon_status(id){
    lunhui.status(id,'<?php echo url("coupon_status"); ?>');
}
