<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/webdata/eintcoin/public/../application/index/view/info/invite.html";i:1523369210;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523452303;}*/ ?>
<!DOCTYPE html>
<html>
...
<button type="button" class="layui-btn" onclick="create();">生成邀请码</button>
<!-- <img id="img_invite" src="" alt=""> -->
<div>你的邀请码链接：<span id="invite_link"></span></div>
<script>
  function create(){
    $.ajax({
      async: false,
      type: "GET",
      url: "http://www.eintcoin.com/Index/info/getInvite",
      data: {
      ...
      success: function(data) {
        ...
        // alert(data);
      document.getElementById('invite_link').innerHTML = data.inviteCode;
      },
      error: function(err) {
        console.log(err);
      }
