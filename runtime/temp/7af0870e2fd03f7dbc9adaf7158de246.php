<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/webdata/eintcoin/public/../application/index/view/info/renzhengform.html";i:1523445477;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523452303;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <div class="layui-fluid">
    <div class="layui-row">
      <div class="layui-col-xs12">
        <form class="layui-form" action="<?php echo url('renzhengform'); ?>" method="post" enctype="multipart/form-data">
          <div class="layui-form-item">
            <label class="layui-form-label">姓 名</label>
            <div class="layui-input-inline">
              <input type="text" name="name" required lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input"
                value="<?php if(isset($data['name'])): ?><?php echo $data['name']; endif; ?>">
            </div>
            <span style="color: red"><?php if(isset($message['name'])): ?><?php echo $message['name']; endif; ?></span>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">身份证</label>
            <div class="layui-input-inline">
              <input type="text" name="person_id" required lay-verify="required" placeholder="请输入身份证号" autocomplete="off" class="layui-input"
                value="<?php if(isset($data['person_id'])): ?><?php echo $data['person_id']; endif; ?>">
            </div>
            <span style="color: red"><?php if(isset($message['person_id'])): ?><?php echo $message['person_id']; endif; ?></span>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">银行卡号</label>
            <div class="layui-input-inline">
              <input type="text" name="bank_id" required lay-verify="required" placeholder="请输入银行卡号" autocomplete="off" class="layui-input"
                value="<?php if(isset($data['bank_id'])): ?><?php echo $data['bank_id']; endif; ?>">
            </div>
            <span style="color: red"><?php if(isset($message['bank_id'])): ?><?php echo $message['bank_id']; endif; ?></span>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">银行预留手机号</label>
            <div class="layui-input-inline">
              <input type="text" name="bank_mobile" required lay-verify="required" placeholder="请输入银行预留手机号" autocomplete="off" class="layui-input"
                value="<?php if(isset($data['bank_mobile'])): ?><?php echo $data['bank_mobile']; endif; ?>">
            </div>
            <span style="color: red"><?php if(isset($message['bank_mobile'])): ?><?php echo $message['bank_mobile']; endif; ?></span>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">交易密码</label>
            <div class="layui-input-inline">
              <input type="text" name="transaction_password" required lay-verify="required" placeholder="请输入6位数字交易密码" autocomplete="off"
                class="layui-input" value="<?php if(isset($data['transaction_password'])): ?><?php echo $data['transaction_password']; endif; ?>">
            </div>
            <span style="color: red"><?php if(isset($message['transaction_password'])): ?><?php echo $message['transaction_password']; endif; ?></span>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">手持身份证银行卡照片</label>
            <div class="layui-input-inline">
              <div class="layui-upload">
                <input type="file" name="person_img">
              </div>
            </div>
            <div class="layui-form-mid layui-word-aux" style="color: red;">图片最大尺寸1M</div>
            <span style="color: red"><?php if(isset($imgMessage)): ?><?php echo $imgMessage; endif; ?></span>
            <span style="color: red"><?php if(isset($message['person_img'])): ?><?php echo $message['person_img']; endif; ?></span>
          </div>
          <div class="layui-form-item">
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="2" align="center">
                      <button class="layui-btn layui-btn-primary layui-btn-radius">点击修改</button>
                    </td>
                  </tr>
                </tbody>
              </table>
