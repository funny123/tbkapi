<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"F:\myphp_www\PHPTutorial\WWW\eintcoin\public/../application/admin\view\mills\index_cate.html";i:1521784340;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\header.html";i:1527512283;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\footer.html";i:1521703318;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        $.getJSON('./del_cate', {'id' : id}, function(res){
            if(res.code == 1){
                layer.msg(res.msg,{icon:1,time:1500,shade: 0.1},function(){
                    window.location.href="<?php echo url('mills/index_cate'); ?>";
                });               
            }else{
