<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\myphp_www\PHPTutorial\WWW\eintcoin\public/../application/admin\view\article\index.html";i:1517894894;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\header.html";i:1527512283;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\footer.html";i:1521703318;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">         
            ...
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item>
                    ...
                    <a shiro:hasPermission="admin:article:del" type="button" class="btn btn-danger" @click="del">
                ...
                <div class="example" >
                    <el-table :data="tableData" border highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中..." @selection-change="handleSelectionChange" style="width: 100%">
                        ...
                        <el-table-column align="center" width="120" label="操作">
                            <template scope="scope">
                                <el-button shiro:hasPermission="admin:article:edit" size="small" type="text" @click="edit(scope.row)">编辑</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
