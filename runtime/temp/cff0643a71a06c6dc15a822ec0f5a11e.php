<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/webdata/eintcoin/public/../application/index/view/info/info.html";i:1523443954;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523452303;}*/ ?>
<!DOCTYPE html>
<html>
          ...
          <table class="layui-table radius20">
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo \think\Session::get('user.account'); ?></td>
              </tr>
              <tr>
                <td align="right">手机号</td>
                <td><?php echo \think\Session::get('user.mobile'); ?></td>
              </tr>
              <tr>
                <td align="right">常用QQ</td>
                <td><?php if(is_null(\think\Session::get('user.qq'))): ?><button data-type="auto" class="setqq layui-btn layui-btn-sm">点击设置</button><?php else: ?><?php echo \think\Session::get('user.qq'); endif; ?></td>
              </tr>
              <tr>
                <td align="right">微信号</td>
                <td><?php if(is_null(\think\Session::get('user.wechat'))): ?><button data-type="auto" class="setwx layui-btn layui-btn-sm">点击设置</button><?php else: ?><?php echo \think\Session::get('user.wechat'); endif; ?></td>
              </tr>
              <tr>
                <td align="right">状态</td>
                <td><?php if(\think\Session::get('user.status') == 1): ?>正常<?php else: ?>禁用<?php endif; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
