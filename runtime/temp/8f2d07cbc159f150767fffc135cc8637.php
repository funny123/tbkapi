<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/webdata/eintcoin/public/../application/index/view/info/my_money.html";i:1523422101;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523452303;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-layout-body">
	...
	<div class="layui-fluid">
		<div class=" layui-bg-gray">
			...
			<div class="layui-row layui-col-space30" style="padding: 0 30px 15px 30px">
				<div class="layui-col-sm6 layui-col-md4 layui-col-lg4">
					<div class="layui-card">
						<div class="layui-card-body">
							<div style="text-align: center;">
								<div class="layui-anim" data-anim="layui-anim-up">
									<img src="/static/index/img/yellow_coin1.png" alt="" width="100px" height="100px">
								</div>
								<ul style="line-height:1.5">
									...
									<li>
										<ul>
											<li>
												<h3>
													<img src="/static/index/img/yellow_coin1.png" alt="" width="40px" height="40px"> 收入</h3>
											</li>
											<li>
												<h3>
													<img src="/static/index/img/yellow_coin1.png" alt="" width="40px" height="40px"> 支出</h3>
											</li>
										</ul>
									</li>
									<li>
				...
				<div class="layui-col-sm6 layui-col-md4 layui-col-lg4">
					<div class="layui-card">
						<div class="layui-card-body">
								<div style="text-align: center;">
									<div class="layui-anim" data-anim="layui-anim-up">
										<img src="/static/index/img/dj_coin.png" alt="" width="100px" height="100px">
									</div>
									<ul style="line-height:1.5">
										<li>
											<h2>总计：500</h2>
										...
										<li>
											<ul>
												<li>
													<h3>
														<img src="/static/index/img/yellow_coin1.png" alt="" width="40px" height="40px"> </h3>
												</li>
												<li>
													<h3>
														<img src="/static/index/img/blue_coin1.png" alt="" width="40px" height="40px"> </h3>
												</li>
											</ul>
										</li>
										<li>
				...
				<div class="layui-col-sm6 layui-col-md4 layui-col-lg4">
					<div class="layui-card">
						<div class="layui-card-body">
							<div style="text-align: center;">
								<div class="layui-anim" data-anim="layui-anim-up">
									<img src="/static/index/img/blue_coin1.png" alt="" width="100px" height="100px">
								</div>
								<ul style="line-height:1.5">
									<li>
										<h2>总计：500</h2>
									...
									<li>
										<ul>
											<li>
												<h3>
													<img src="/static/index/img/blue_coin1.png" alt="" width="40px" height="40px"> 收入</h3>
											</li>
											<li>
												<h3>
													<img src="/static/index/img/blue_coin1.png" alt="" width="40px" height="40px"> 支出</h3>
											</li>
										</ul>
									</li>
									<li>
