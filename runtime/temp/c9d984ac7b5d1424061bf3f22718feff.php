<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/webdata/eintcoin/public/../application/index/view/info/my_team.html";i:1523190478;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523452303;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class=" layui-bg-gray">
			<div class="layui-row">
				<div class="layui-col-md12">
					<div class="layui-card radius10" style="margin:15px">
						<div class="layui-card-body" style="text-align: center;">
							<h1>
								<img src="/static/index/img/team/touxiang.png" alt="" width="80px" height="80px">
							</h1>
							<h2>我的团队</h2>
						</div>
					</div>
					<div class="layui-card radius10" style="margin:15px">
						<div class="layui-card-header">我的团队信息</div>
						<div class="layui-card-body" style="padding:0">
							<table class="layui-table" lay-skin="line" align="center">
								<tbody>
									<tr>
										<td align="center">战队 QQ 群：</td>
										<td>313131</td>
										<td></td>
									</tr>
									<tr>
										<td align="center">战队领导人：</td>
										<td>老八</td>
										<td></td>
									</tr>
									<tr>
										<td align="center">团队总人数：</td>
										<td>108</td>
										<td></td>
									</tr>
									<tr>
										<td align="center">团队总算力：</td>
										<td>208</td>
										<td></td>
									</tr>
								</tbody>
									...
									<div class="layui-colla-title">
										<table style="width:100%">
											<tbody>
												<tr>
													<td>
														<img src="/static/index/img/team/touxiang.png" alt="" width="40px" height="40px">
													</td>
													<td>Id:3123<br>级别：二级
													</td>
													<td>已认证</td>
													<td>微信：asda2313<br>QQ:13123132
													</td>
													<td>
														币量：10<br>算力：10
													</td>
