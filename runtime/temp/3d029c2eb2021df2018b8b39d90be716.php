<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/webdata/eintcoin/public/../application/index/view/info/pai.html";i:1523189761;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523449550;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-layout-body">
	...
	<div class="layui-fluid">
		<div class=" layui-bg-gray">
			<div class="layui-row layui-col-space30" style="padding: 15px 30px">
				<div class="layui-col-md4 layui-col-md-offset4">
					<div class="layui-card radius15">
						...
						<div class="layui-tab-content">
							<div class="layui-tab-item layui-show">
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 头条
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
											直推人数：258
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/jiangbei1.png" alt="" width="50px" height="50px">
										</div>
									</div>
								</div>
								<!-- 2 -->
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 小米
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
									...
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/jiangbei2.png" alt="" width="50px" height="50px">
										</div>
									</div>
								</div>
								<!-- 3 -->
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 大米
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
									...
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/jiangbei3.png" alt="" width="50px" height="50px">
										</div>
									</div>
								</div>
							</div>
							<div class="layui-tab-item">
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 玉米
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
								...
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 土豆
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
								...
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 红薯
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
							...
							<div class="layui-tab-item">
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 小麦
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
								...
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 二锅头
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
								...
								<div class="layui-row">
									<div class="layui-col-md4">
										<div class="grid-demo grid-demo-bg1">
											<img src="/static/index/img/team/touxiang.png" alt="" width="50px" height="50px"> 洋葱
										</div>
									</div>
									<div class="layui-col-md4">
										<div class="grid-demo" style="margin-top:15px;">
					...
					<div class="layui-col-md3">
						<div class="layui-bg-gray">
							<div class="" style="padding:14px">
								...
								<div class="layui-btn">￥<span id="nowPrice"></span></div>
							</div>
							<div id="jiaoyi" class="layui-bg-gray">

								<marquee direction="up" align="bottom" width="100%" onmouseout="this.start()" onmouseover="this.stop()" scrollamount="2"
								  scrolldelay="1">
	...
	<script>
		...
		var orderUrl = '/api/order/getallorder';
		$.get(orderUrl,function (res) {
		    ...
		    $.each(res,function (i,v) {
                ...
                '<td>'+v.account+'</td>'+
                '<td>ID:'+v.id+'</td>'+
                '<td>'+v.type+parseFloat(v.number)+'币</td>'+
                '<td>总计'+parseFloat(v.total)+'￥</td>'+
                '</tr>'
            });
			$('#order').append(html);
        },'json');
