<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/webdata/eintcoin/public/../application/index/view/info/team_income.html";i:1523193291;s:58:"/webdata/eintcoin/application/index/view/public/index.html";i:1523449550;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="layui-card-body">
							<div style="text-align: center;">
								<div class="layui-anim" data-anim="layui-anim-up">
									<img src="/static/index/img/team/1.png" alt="" width="150px" height="150px">
								</div>
								<div class="code">
									<h2>推广收益</h2>
									<h1>
									...
									<p>
										<span style="font-size:3px;">(总人数)</span>
									</p>
									<p>时间：
										<span>2018-04-02</span> 人数：
										<span>2</span>
									</p>
									<h1 class="zsy">总收益:
										<span>132</span>
				...
				<div class="layui-col-sm6 layui-col-md4 layui-col-lg4">
					<div class="layui-card">
						<div class="layui-card-body">
							<div style="text-align: center;">
								<div class="layui-anim" data-anim="layui-anim-up">
									<img src="/static/index/img/team/2.png" alt="" width="150px" height="150px">
								</div>
								<div class="code">
									<h2>矿机分红</h2>
									<h1>
									...
									<p>
										<span style="font-size:3px;">(总算力)</span>
									</p>
									<p>时间：
										<span>2018-04-02</span> 算力：
										<span>5</span>
									</p>
									<h1 class="zsy">总分红:
										<span>200</span>
						...
						<div class="layui-card-body">
							<div style="text-align: center;">
								...
								<div class="code">
									...
									<p>
										<span style="font-size:3px;">(总币数)</span>
									</p>
									<p>时间：
										<span>2018-04-02</span> 币量：
										<span>2</span>
									</p>
									<h1 class="zsy">总提成:
										<span>50</span>
