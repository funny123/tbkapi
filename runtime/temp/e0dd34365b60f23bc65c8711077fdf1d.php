<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\myphp_www\PHPTutorial\WWW\eintcoin\public/../application/admin\view\mills\index.html";i:1521789119;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\header.html";i:1527512283;s:79:"F:\myphp_www\PHPTutorial\WWW\eintcoin\application\admin\view\public\footer.html";i:1521703318;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">         
            ...
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item>
                    ...
                    <a href="<?php echo url('add_mills'); ?>" type="button" class="btn btn-primary" >
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            loadData(key, currentPage, pageSize){
                vm.listLoading = true;
                $.getJSON('<?php echo url("mills/index"); ?>', {key:key,page:currentPage,rows:pageSize}, function(data){
                    vm.tableData = [];
            ...
            del() {
                ...
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    $.ajax({
                        url: '<?php echo url("mills/del_mills"); ?>',
                        data:"id="+array,
                        type: "POST",
                        dataType:'json',
